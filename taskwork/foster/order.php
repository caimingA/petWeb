...
if($row_01['catPrice'] < $row_02['catPrice'])
{
    if( $row_02['catPrice'] < $row_03['catPrice'] )
    {
        $final = array($situation_01, $situation_02, $situation_03);
    }
    else
    {
        if($row_01['catPrice'] < $row_03['catPrice'])
        {
            $final = array($situation_01, $situation_03, $situation_02);
        }
        else
        {
            $final = array($situation_03, $situation_01, $situation_02);
        }
    }
}
else
{
    if($row_02['catPrice'] > $row_03['catPrice'])
    {
        $final = array($situation_03, $situation_02, $situation_01);
    }
    else
    {
        if($row_01['catPrice'] > $row_03['catPrice'])
        {
            $final = array($situation_02, $situation_03, $situation_01);
        }
        else
        {
            $final = array($situation_02, $situation_01, $situation_03);
        }
    }
